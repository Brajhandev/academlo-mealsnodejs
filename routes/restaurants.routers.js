...
Restaurantsrouters.patch("/reviews/:restaurantId/:id/",reviewsExists,validateTokenAndUser,updateReview);

Restaurantsrouters.delete("/reviews/:restaurantId/:id/",reviewsExists,validateTokenAndUser,deleteReview);
